...
def prepare(df, stats_file):
    with open(stats_file, "w") as f:
        ...
        print("After dropping these, n is {}".format(len(df.index)), file=f)
        ...
        n_itineraries_direct_taxi = df_itineraries["is_direct_taxi"].value_counts()[
            True
        ]
        ...
        percentage_itineraries_pt_only = (
            n_itineraries_pt_only / n_itineraries_total * 100
        )
        percentage_itineraries_pt_taxi = (
            n_itineraries_pt_taxi / n_itineraries_total * 100
        )
